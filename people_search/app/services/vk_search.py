...
class BuratinoVKSearch:
    ...
    def search(
        ...
        try:
            from .vk_web_search import VKWebSearch
    ...
    def search_expanded(
        ...
        if len(all_profiles) < 5:
            ...
            try:
                from .transliteration import transliterate_name_part, generate_username_patterns
    ...
    def search_and_save(
        ...
        """
        raise NotImplementedError("save_to_investigation is not available in standalone People Search app")
