...
INTEGRATIONS = [
    ...
    {"name": "Search4Faces API", "code": ["app/services/phase2/search4faces_service.py", "app/services/phase2/face_search_api.py"], "env": ["SEARCH4FACES_API_KEY"], "where": "provider dashboard or secret store", "verify": "Confirm key presence locally, then run manual verification with approved test media.", "dashboard": True},
    ...
    {"name": "Holehe CLI", "code": ["app/services/phase2/holehe_service.py"], "cmd": ["holehe"], "where": "local Python environment / PATH", "verify": "Confirm the CLI is on PATH or use the library path manually."},
